...
import com.yj.cosmetics.ui.fragment.MyFreeOrderFragment;
				...
				public void gotResult(int code, String alias, Set<String> tags) {
					switch (code) {
						case 0:
							...
							//"Set tag and alias success极光推送别名设置成功"
							preferencesUtil.setBooleanValue("is_register_jpush_alias", false);
							break;
						case 6002:
							//极低的可能设置失败 我设置过几百回 出现3次失败 不放心的话可以失败后继续调用上面那个方面 重连3次即可 记得return 不要进入死循环了...
							//"Failed to set alias and tags due to timeout. Try again after 60s.极光推送别名设置失败，60秒后重试"
							break;
						default:
							//"极光推送设置失败，Failed with errorCode = " + code
							break;
					}
				}
			});
