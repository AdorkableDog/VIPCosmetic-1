...
public class HomeGoodsListActivity extends BaseActivity {
	...
	private String shopId, classifyId, type, name, TAG, productIds, orderId, isVip;
	...
	protected void initView() {
		...
		Log.e("-0-","=="+orderId);
		instant = HomeGoodsListFrag.instant(shopId, classifyId, type, name, TAG, productIds,orderId,isVip);
