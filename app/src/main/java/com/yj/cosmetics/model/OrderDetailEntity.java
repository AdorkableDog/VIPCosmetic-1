...
public class OrderDetailEntity {
	...
	public static class OrderDetialData {
		...
		private List<OrderDetialItem> itemsList;
		private String content;
		private String ftime;
		private String proMoneyAll;
		private String shopOrderId;
		private String superiorOrderName;
		...
		public List<OrderDetialItem> getItemsList() {
			return itemsList;
		}

		public void setItemsList(List<OrderDetialItem> itemsList) {
		...
		public String getSuperiorOrderName() {
			return superiorOrderName;
		}

		public void setSuperiorOrderName(String superiorOrderName) {
			this.superiorOrderName = superiorOrderName;
		}
		...
		public static class OrderDetialItem implements Parcelable {
			...
			public static final Creator<OrderDetialItem> CREATOR = new Creator<OrderDetialItem>() {
				...
				public OrderDetialItem createFromParcel(Parcel source) {
					...
					orderDetialItem.isVip = source.readString();
					orderDetialItem.superiorOrderName = source.readString();
			...
			public void writeToParcel(Parcel dest, int flags) {
				...
				dest.writeString(superiorOrderName);
			}
		}
	}
}